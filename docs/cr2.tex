...
also the semi-core (3s,3p) electrons, making a total of 28 correlated electrons.
...
The shape of the experimental curve is deduced from measuring 30 vibrational states using negative-ion photoelectron spectroscopy~\cite{casey1993negative}.
...
By including the 10 additional electrons from the semi-core into the active space, SHCI achieves much better agreement,
...
We also compare in Fig.~\ref{fig:hfcc} SHCI results to unrestricted Hartree-Fock (UHF) and unrestricted coupled cluster methods, UCCSD and UCCSD(T).
