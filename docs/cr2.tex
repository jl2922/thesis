...
\begin{figure}
  ...
  The CAS-core curve gives a lower energy, closer to experiment, but
...
We can see that both the energy and the shape of the curve from using CAS-core is much closer to the experimental curve than using just the HF-core.
