...
As expected, high excitation orders are necessary to get an agreement with FCIQMC at the larger $r_s$ values.
...
%In addition, we optimize the storage and the usage of the double excitation lists, taking into consideration the momentum conservation property of the plane-wave based orbitals of HEG.
